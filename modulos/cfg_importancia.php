...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_tipo_objeto, tx_tipo, CASE WHEN nu_predeterminado=true THEN 'Verdadero' ELSE 'Falso' END AS nu_predeterminado FROM vie_tipo_importancia";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"tx_tipo"  =>array("header"=>"Servicio","header_align"=>"center","type"=>"label", "width"=>"90%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"nu_predeterminado"  =>array("header"=>"Sel.","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_tipo" =>array("header"=>"Importancia", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"tx_objeto" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>"tipo importancia", "visible"=>"false", "unique"=>false),
