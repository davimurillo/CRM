...
<body>
	...
	<?php if(isset($_REQUEST['f'])){  require_once('common.php'); checkUser(); echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="">';}else{?>
	<?php include('cfg_encabezado.php'); ?>
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style=" width:100%; font-size:18px; color:#888;" >

			<a href="index.php">Inicio</a> | Oportunidad <img class="ayuda" src="../img/botones/ayuda.png" title="Ayuda al Usuario" style="margin-left:8px; margin-top:-2px" /> <i class="fa fa-print" style="font-size:14px" title="Imprimir Reportes" onclick="javascript:reportes();"></i>
	</div>
	...
	<div class="col_lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px"> 
		...
		<select id="empresa" class="form-control" onchange="javascript:location.href='mod_oportunidades.php?empresa='+this.value;">
...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_oportunidad,tx_servicio, fe_inicio, fe_probable_cierre, tx_condicion, nu_avance,tx_documento,tx_status FROM vie_oportunidad a WHERE id_empresa=".$empresa;
##  *** set needed options
  $debug_mode = false;
  $messaging = true;
  $unique_prefix = "f_";  
...
##  *** set data source with needed options
  $default_order_field = "id_oportunidad";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
 	...
 	$vm_colimns = array(
	"tx_servicio"  =>array("header"=>"Servicio","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"fe_inicio"  =>array("header"=>"Fecha Inicio","header_align"=>"center","type"=>"label", "width"=>"5%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"fe_probable_cierre"  =>array("header"=>"Fecha Cierre","header_align"=>"center","type"=>"label", "width"=>"5%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_condicion"  =>array("header"=>"Condición","header_align"=>"center","type"=>"label", "width"=>"20%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"nu_avance"  =>array("header"=>"Avance %","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_documento"  =>array("header"=>"Documento","header_align"=>"center","type"=>"label", "width"=>"40%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_status"  =>array("header"=>"Estatus","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
  );
...
##  ***  set settings for edit/details mode
  ...
  $table_name = "tbl_oportunidad";
  $primary_key = "id_oportunidad";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
 	"fecha_inicio" =>array("header"=>"Fecha de Inicio", "type"=>"datedmy",   "req_type"=>"rt", "width"=>"100px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "calendar_type"=>"floating"),
	...
	"id_condicion" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>1, "visible"=>"false", "unique"=>false),
