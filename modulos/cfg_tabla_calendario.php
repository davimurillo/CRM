...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_calendario,fe_calendario, tx_dia, in_nohabil FROM cfg_calendario";
...
##  *** set data source with needed options
  $default_order_field = "id_calendario";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"fe_calendario"  =>array("header"=>"Fecha","header_align"=>"center","type"=>"label", "width"=>"80%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_dia"  =>array("header"=>"dia semana","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"in_nohabil"  =>array("header"=>"Habilitado","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
 ...
 $estatus=array("true"=>"true", "false"=>"false");
  ...
  $table_name = "cfg_calendario";
  $primary_key = "id_calendario";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
 	
	"fe_calendario" =>array("header"=>"Fecha", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"tx_dia" =>array("header"=>"Dia de la semana", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"in_nohabil" =>array("header"=>"Habilitado?", "type"=>"enum",  "source"=>$estatus, "view_type"=>"dropdownlist", "width"=>"210px", "req_type"=>"ry", "title"=>"", "unique"=>false),
