...
##  *** put a primary key on the first place 
	...
	$sql="SELECT  id_parametro, tx_parametro, tx_valor FROM cfg_parametro";
...
##  *** set data source with needed options
  $default_order_field = "tx_parametro";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"tx_parametro"  =>array("header"=>"Tipo","header_align"=>"center","type"=>"label", "width"=>"80%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_valor"  =>array("header"=>"Valor","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
 ...
 $estatus=array("true"=>"true", "false"=>"false");
  ...
  $table_name = "cfg_parametro";
  $primary_key = "id_parametro";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
 	
	"tx_parametro" =>array("header"=>"Nombre", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"tx_valor" =>array("header"=>"Valor", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
