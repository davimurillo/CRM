...
##  *** put a primary key on the first place 
	...
	$sql="SELECT  id_tipo_objeto, tx_objeto, tx_tipo, CASE WHEN nu_predeterminado=true THEN 'Verdadero' ELSE 'Falso' END AS nu_predeterminado, nu_orden FROM cfg_tipo_objeto";
...
##  *** set data source with needed options
  $default_order_field = "tx_objeto, nu_predeterminado, nu_orden";
//  $default_order_field = "direccion,primer_apellido";
  $default_order_type = "ASC, DESC, ASC";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	"tx_objeto"  =>array("header"=>"Objeto","header_align"=>"center","type"=>"label", "width"=>"30%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_tipo"  =>array("header"=>"Tipo","header_align"=>"center","type"=>"label", "width"=>"45%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
 ...
 $estatus=array("true"=>"true", "false"=>"false");
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_objeto" =>array("header"=>"Objeto", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
