...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_tipo_objeto, tx_tipo, CASE WHEN nu_predeterminado=true THEN 'Verdadero' ELSE 'Falso' END AS nu_predeterminado FROM vie_servicio";
...
##  ***  set settings for edit/details mode
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_tipo" =>array("header"=>"Servicio", "type"=>"textbox", "width"=>"100%", "req_type"=>"rty", "title"=>"", "unique"=>false),
	"tx_objeto" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>"servicio", "visible"=>"false", "unique"=>false),
