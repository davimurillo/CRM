...
##  *** put a primary key on the first place 
  	...
  	$sql="SELECT id_seguimiento, tx_descripcion, (SELECT tx_tipo FROM cfg_tipo_objeto WHERE id_tipo_objeto=a.id_tipo) AS tipo,(SELECT tx_tipo FROM cfg_tipo_objeto WHERE id_tipo_objeto=a.id_status) AS estatus FROM tbl_seguimiento a WHERE id_oportunidad=".$_POST['id'];
