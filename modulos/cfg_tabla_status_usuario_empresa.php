...
##  *** put a primary key on the first place 
	...
	$sql="SELECT  id_tipo_objeto, tx_objeto, tx_tipo, CASE WHEN nu_predeterminado=true THEN 'Verdadero' ELSE 'Falso' END AS nu_predeterminado, nu_orden FROM cfg_tipo_objeto WHERE tx_objeto='status usuario empresa'";
 ...
 $estatus=array("true"=>"true", "false"=>"false");
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"tx_objeto" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>"status usuario empresa", "visible"=>"false", "unique"=>false)
