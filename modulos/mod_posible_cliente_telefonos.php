...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_empresa_telefono, tx_telefono, (SELECT tx_tipo FROM vie_tipo_telefono WHERE id_tipo_objeto=a.id_tipo_telefono) as id_tipo_telefono FROM tbl_empresa_telefono a WHERE id_empresa=".$_GET['id'];
...
##  *** set data source with needed options
  $default_order_field = "id_empresa_telefono";
...
##  ***  set settings for edit/details mode
 ...
 //*****ARREGLO PARA CAMPO TIPO IMPORTANCIA******//
  ...
  $table_name = "tbl_empresa_telefono";
  $primary_key = "id_empresa_telefono";
  $condition = "";
