...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_empresa_direccion, tx_direccion, (SELECT tx_tipo FROM vie_tipo_direccion WHERE id_tipo_objeto=a.id_tipo_direccion) as id_tipo_direccion FROM tbl_empresa_direccion a WHERE id_empresa=".$_GET['id'];
...
##  *** set data source with needed options
  $default_order_field = "id_empresa_direccion";
...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
 	...
 	$vm_colimns = array(
	"id_tipo_direccion"  =>array("header"=>"Tipo","header_align"=>"center","type"=>"label", "width"=>"10%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	"tx_direccion"  =>array("header"=>"Dirección","header_align"=>"center","type"=>"label", "width"=>"90%", "align"=>"center",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal")
...
##  ***  set settings for edit/details mode
 ...
 //*****ARREGLO PARA CAMPO TIPO IMPORTANCIA******//
	 $tema_array_sql = "SELECT tx_tipo,id_tipo_objeto FROM vie_tipo_direccion";
	$especial_array_str = crearArregloDataGrid($tema_array_sql,"tipo_direccion_array",g_BaseDatos);
	eval($especial_array_str);		
	//******FIN DE ARREGLO******///

  $table_name = "tbl_empresa_direccion";
  $primary_key = "id_empresa_direccion";
  $condition = "";
  $dgrid->setTableEdit($table_name, $primary_key, $condition);
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
 	"id_tipo_direccion" =>array("header"=>"Tipo", "type"=>"enum",  "source"=>$tipo_direccion_array, "view_type"=>"dropdownlist", "width"=>"210px", "req_type"=>"ry", "title"=>"Seleccione un tipo de dirección", "unique"=>false),
	...
	"id_empresa" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>$_GET['id'], "visible"=>"false", "unique"=>false)
