...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<div id="print" align="left" ><h3>Reporte de Ventas</h3><hr></div>
...
<tr class="active" >
  ...
  <?php 
   ...
   $sql="SELECT tx_nombre, tx_nombre_apellido, tx_cargo, tx_tipo_condicion_contacto, tx_correo_primario, tx_telefono_con, tx_tipo_telefono_con  FROM vie_empresa_contacto_usuario WHERE 1=1";
  if ($_SESSION['rol']<3){
