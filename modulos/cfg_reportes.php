...
##  *** put a primary key on the first place 
  $sql="select id_reporte,tx_reporte from cfg_reportes";
...
##  *** set columns in view mode
 ...
 $vm_colimns = array(
	...
	"tx_reporte"  =>array("header"=>"Reporte",      "type"=>"label", "width"=>"100%", "align"=>"left",    "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),
