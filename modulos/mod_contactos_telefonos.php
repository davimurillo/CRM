...
##  *** put a primary key on the first place 
	...
	$sql="SELECT id_contacto_telefono, tx_telefono, (SELECT tx_tipo FROM vie_tipo_telefono WHERE id_tipo_objeto=a.id_tipo_telefono) as id_tipo_telefono FROM tbl_contacto_telefono a WHERE id_contacto=".$_GET['id'];
...
##  *** set data source with needed options
  $default_order_field = "id_contacto_telefono";
...
##  ***  set settings for edit/details mode
 ...
 //*****ARREGLO PARA CAMPO TIPO IMPORTANCIA******//
  ...
  $table_name = "tbl_contacto_telefono";
  $primary_key = "id_contacto_telefono";
  $condition = "";
  ...
  $dgrid->setAutoColumnsInEditMode(false);
   $em_columns = array(
	...
	"id_contacto" =>array("header"=>"",       "type"=>"hidden",    "req_type"=>"st", "default"=>$_GET['id'], "visible"=>"false", "unique"=>false)
