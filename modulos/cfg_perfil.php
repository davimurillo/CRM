...
##  *** set columns in view mode
  ...
  $dgrid->SetViewModeTableProperties($vm_table_properties); 
	...
	//"modulos"=>array("header"=>"Modulos", "type"=>"link",						"align"=>"center", "width"=>"5%", "wrap"=>"wrap", "text_length"=>"-1", "tooltip"=>"true",							"tooltip_type"=>"floating", "case"=>"normal", "summarize"=>"false", "sort_type"=>"numeric", "sort_by"=>"",						"visible"=>"true", "on_js_event"=>"", "field_key"=>"id_perfil",							"field_data"=>"modulos", "rel"=>"", "title"=>"Configurar el perfil", "target"=>"", "href"=>"javascript:location.href='cfg_perfil_modulo.php?perfil={0}';")
