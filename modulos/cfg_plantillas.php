...
<div class="panel panel-default">
  <div class="panel-heading" style="font-size:18px; color:#ccc;">Plantillas</div>
...
##  *** put a primary key on the first place 
  	...
  	$sql=" SELECT id_plantilla, titulo FROM cfg_plantilla";
...
##  *** set columns in view mode
   //$dgrid->setAutoColumnsInViewMode(true);  
	...
	$dgrid->SetViewModeTableProperties($vm_table_properties); 
 	...
 	$vm_colimns = array(
		"titulo"  =>array("header"=>"Titulo","header_align"=>"center","type"=>"label", "width"=>"100%", "align"=>"left",    "wrap"=>"wrap", "text_length"=>"-1", "case"=>"normal"),
	 );
...
##  ***  set settings for edit/details mode
	...
	$table_name = "cfg_plantilla";
	$primary_key = "id_plantilla";
	$condition = "";
	$dgrid->setTableEdit($table_name, $primary_key, $condition);
	$dgrid->setAutoColumnsInEditMode(false);
	$em_columns = array(
		"titulo" =>array("header"=>"Titulo", "type"=>"textbox", "width"=>"100%", "req_type"=>"ry", "title"=>"Nombre", "unique"=>false),
		"descripcion" =>array("header"=>"Descripción", "type"=>"textarea", "width"=>"100%", "rows"=>"10", "req_type"=>"ry", "title"=>"Descripción", "unique"=>false)
	);
 ...
 <!-- Include JS files. -->
  ...
  <script>
    ...
    $('#ryydescripcion').froalaEditor({
	  toolbarButtons: ['fullscreen', 'insertImage', 'insertFile', 'bold', 'italic', 'underline', 'insertTable'],
	  toolbarButtonsMD: ['fullscreen', 'insertImage', 'insertFile', 'bold', 'italic', 'underline', 'insertTable'],	
	  toolbarButtonsSM: ['fullscreen', 'insertImage', 'insertFile', 'bold', 'italic', 'underline', 'insertTable'],
	  toolbarButtonsXS: ['fullscreen', 'insertImage', 'insertFile', 'bold', 'italic', 'underline', 'insertTable'],
